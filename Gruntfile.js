...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    usemin: {
        html: ['../newLabProyCompiled/twigs/index.html.twig']
    },
    ...
    imagemin: {                          // Task
      dynamic: {                         // Another target
        files: [{
          ...
          dest: '../newLabProyCompiled/'                  // Destination path prefix
        }]
      }
    },
    ...
    replace: {
      ...
      php: {
        src: '../newLabProyCompiled/settings.yml',
        overwrite: true,
        replacements: [
          {from: 'base_url: /newLabProy/', to: 'base_url: /newLabProyCompiled/'},
